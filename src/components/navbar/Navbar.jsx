            ...
            <div className='py-4'>
                <div className='container flex justify-between items-center'>
                    ...
                    <div className='flex items-center gap-4'>
                        <a
                            href='#' className='text-primary font-semibold tracking-widest text-2xl uppercase sm:text-3xl'>ESHOP
                        </a>
                        {/*Menu Items*/}
                        <div className='hidden lg:block'>
                            <ul className='flex items-center gap-4'>
                                ...
                                <a href='#' className='flex items-center gap-[2px] font-semibold text-gray-500 dark:hover:text-white py-2'>Quick Links  <span>
                    ...
                    <div className='flex justify-between items-center gap-4'>
                        ...
                        <button className='relative p-3' onClick={handleOrderPopup}>
                            ...
                            <div className='w-4 h-4 bg-red-500 text-white rounded-full absolute top-0 right-0 flex items-center justify-center text-xs'> 4
                            </div>
                        </button>
                        <div>
                            <DarkMode />
